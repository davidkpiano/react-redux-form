...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)((0, _redux.combineReducers)({ test: testReducer }));

	var makeAction = function makeAction(e, model) {
	  return {
	    type: 'rsf/' + e.type,
	    model: model,
	...
	function Field(props, state) {
	  ...
	  return _react2.default.createElement(
	    ...
	    { onChange: function onChange(e) {
	        return dispatch(makeAction(e, model));
	      } },
	    _react2.default.createElement('input', { type: 'text', name: '', id: '' })
	  );
	}

	var Foo = (0, _reactRedux.connect)(function (s) {
	  return s;
	})(Field);
	  ...
	  _createClass(App, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        { store: store },
	        _react2.default.createElement(Foo, { model: 'user.name' })
	      );
	    }
	  }]);
