...
function createFieldProps(control, props) {
  ...
  var controlType = props.type || getControlType(control);
...
function createField(control, props) {
  ...
  var controlProps = createFieldProps(control, props);
  var eventActions = createFieldEventActions(control, props);

  if (!controlProps) {
    return _react2.default.cloneElement(control, {
      children: _react2.default.Children.map(control.props.children, function (child) {
        return createField(child, _extends({}, props, child.props));
      })
    });
  }
      ...
      if (props.children.length > 1) {
        return _react2.default.createElement(
          ...
          _react2.default.Children.map(props.children, function (child) {
            return createField(child, props);
          })
        );
      }

      return createField(_react2.default.Children.only(props.children), props);
    }
  }]);
