...
var Field = function (_React$Component) {
  ...
  _createClass(Field, [{
    ...
    value: function createField(control, props) {
      ...
      var controlType = this.props.type || control.type === 'input' ? control.props.type : control.type;

      if (!controlType || !(0, _isString2.default)(controlType)) {
        controlType = control.type.propTypes && control.type.propTypes.onChange ? this.props.control || 'text' : null;
