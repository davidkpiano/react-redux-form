  ...
  return function () {
    ...
    switch (action.type) {
      case actionTypes.CHANGE:
        ...
        if ((0, _isEqual2.default)((0, _get2.default)(state, localPath), action.value)) {
          return state;
        }
      ...
      case actionTypes.RESET:
        ...
        if ((0, _isEqual2.default)((0, _get2.default)(state, localPath), (0, _get2.default)(initialState, localPath))) {
          return state;
        }
